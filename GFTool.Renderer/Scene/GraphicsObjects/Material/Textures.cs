...
namespace GFTool.Renderer.Scene.GraphicsObjects
{
    public partial class Material : IDisposable
    {
        ...
        private static void ResetCommonUniformDefaults(Shader activeShader)
        {
            ...
            activeShader.SetBoolIfExists("EnableFresnelEffect", false);
            activeShader.SetIntIfExists("EnableIrisRefraction", 0);
            activeShader.SetBoolIfExists("EnableEmissionLayer", false);
            activeShader.SetBoolIfExists("PremultiplyAlpha", false);
            activeShader.SetBoolIfExists("EnableWaveAnimation", false);
            activeShader.SetBoolIfExists("EnableFlowMap", false);
            activeShader.SetBoolIfExists("EnableDepthFade", false);
            activeShader.SetBoolIfExists("EnableVertexFoamMask", false);
            activeShader.SetBoolIfExists("EnableVertexAnimationMask", false);
            activeShader.SetBoolIfExists("EnableScreenSpaceReflection", false);
            activeShader.SetBoolIfExists("EnableVertexAlpha", false);
            activeShader.SetBoolIfExists("EnableConservativeFoamFade", false);
            activeShader.SetBoolIfExists("EnableBinormalWaveDirection", false);
            activeShader.SetBoolIfExists("EnableHorizonFog", false);
            activeShader.SetBoolIfExists("EnableFresnelTexture", false);
            activeShader.SetBoolIfExists("EnableFresnelEmission", false);
            activeShader.SetBoolIfExists("EnableLocalIBL", false);
            activeShader.SetBoolIfExists("EnableDisplacementMap", false);
            activeShader.SetBoolIfExists("EnableTeraEffect", false);
            activeShader.SetVector3IfExists("TeraColor", Vector3.One);
            activeShader.SetFloatIfExists("TeraStrength", 1.0f);

            activeShader.SetBoolIfExists("EnableVertexBaseColor", false);
            activeShader.SetBoolIfExists("EnableVertexSelectedChannel", false);
            activeShader.SetBoolIfExists("EnableWorldXzUv", false);
            activeShader.SetBoolIfExists("EnablePackedMap", false);
            activeShader.SetBoolIfExists("EnableMetallicValue", false);
            activeShader.SetIntIfExists("VertexColorChannel", 0);
            activeShader.SetFloatIfExists("VertexColorIntensity", 0.0f);
            activeShader.SetFloatIfExists("Influence", 1.0f);
            activeShader.SetFloatIfExists("Contrast", 1.0f);
            activeShader.SetFloatIfExists("Tiling", 1.0f);
            activeShader.SetFloatIfExists("Influence1", 1.0f);
            activeShader.SetFloatIfExists("Contrast1", 1.0f);
            activeShader.SetFloatIfExists("Tiling1", 1.0f);
            activeShader.SetFloatIfExists("Tiling2", 1.0f);
            activeShader.SetFloatIfExists("RoughnessIntensity", 1.0f);
            activeShader.SetFloatIfExists("RoughnessIntensity1", 1.0f);
            activeShader.SetFloatIfExists("NormalIntensity", 1.0f);
            activeShader.SetFloatIfExists("NormalIntensity1", 1.0f);
            activeShader.SetFloatIfExists("RoughnessIntensity2", 1.0f);
            activeShader.SetFloatIfExists("NormalIntensity2", 1.0f);
            activeShader.SetFloatIfExists("LayerMaskScale1", 1.0f);
            activeShader.SetIntIfExists("VertexColorChannel1", 0);
            activeShader.SetFloatIfExists("MetallicIntensity", 1.0f);
            activeShader.SetFloatIfExists("MetallicIntensity1", 1.0f);
            activeShader.SetFloatIfExists("MetallicIntensity2", 1.0f);
            activeShader.SetFloatIfExists("BaseColorMapSaturation", 1.0f);
            activeShader.SetVector4IfExists("ParallaxUVIntensity", Vector4.Zero);
            activeShader.SetFloatIfExists("LocalSpecularProbeIntensity", 1.0f);

            activeShader.SetFloatIfExists("FlowPower", 0.0f);
            activeShader.SetFloatIfExists("FlowScaleX", 1.0f);
            activeShader.SetFloatIfExists("FlowScaleY", 1.0f);
            activeShader.SetFloatIfExists("FoamMaskUVScale", 1.0f);
            activeShader.SetFloatIfExists("FoamMaskIntensity", 0.0f);
            activeShader.SetFloatIfExists("FoamFlowPower", 0.0f);
            activeShader.SetFloatIfExists("SoftEdgeRatio", 0.2f);
            activeShader.SetFloatIfExists("FoamEdgeRatio", 0.2f);
            activeShader.SetFloatIfExists("FoamSharpness", 1.0f);
            activeShader.SetFloatIfExists("FoamNormalInfluence", 0.0f);
            activeShader.SetFloatIfExists("FoamWaveInfluence", 0.0f);
            activeShader.SetFloatIfExists("FoamWaveHeightMin", -1.0f);
            activeShader.SetFloatIfExists("FoamWaveHeightMax", 1.0f);
            activeShader.SetFloatIfExists("WaveAmplitude0", 0.0f);
            activeShader.SetFloatIfExists("WaveAmplitude1", 0.0f);
            activeShader.SetFloatIfExists("WaveSpeed0", 0.0f);
            activeShader.SetFloatIfExists("WaveSpeed1", 0.0f);
            activeShader.SetFloatIfExists("WaveLength0", 1.0f);
            activeShader.SetFloatIfExists("WaveLength1", 1.0f);
            activeShader.SetFloatIfExists("WaveDirectionX0", 1.0f);
            activeShader.SetFloatIfExists("WaveDirectionY0", 0.0f);
            activeShader.SetFloatIfExists("WaveSteepness0", 0.0f);
            activeShader.SetFloatIfExists("WaveBinormalInfluence", 0.0f);
            activeShader.SetFloatIfExists("WaterFogNearLength", 0.32f);
            activeShader.SetFloatIfExists("WaterFogFarLength", 50.0f);
            activeShader.SetFloatIfExists("WaterFogPower", 1.0f);
            activeShader.SetVector4IfExists("WaterFogColorNear", Vector4.One);
            activeShader.SetVector4IfExists("WaterFogColorFar", Vector4.One);
            activeShader.SetVector4IfExists("FoamColor", Vector4.One);
            activeShader.SetFloatIfExists("WaterSpecThresholdMin", 0.0f);
            activeShader.SetFloatIfExists("WaterSpecThresholdMax", 1.0f);
            activeShader.SetFloatIfExists("ReflectionScaleX", 0.0f);
            activeShader.SetFloatIfExists("ReflectionScaleY", 0.0f);
            ...
            activeShader.SetFloatIfExists("DisplacementHeight", 0.0f);
            ...
            activeShader.SetVector4IfExists("FresnelColor", Vector4.One);
            activeShader.SetFloatIfExists("FresnelIntensity", 0.0f);
            activeShader.SetFloatIfExists("FresnelPower", 5.0f);
            activeShader.SetFloatIfExists("FresnelAngleBias", 0.0f);
            ...
            activeShader.SetVector4IfExists("ScrollUVSpeed", Vector4.Zero);
            activeShader.SetVector4IfExists("ScrollUVSpeed1", Vector4.Zero);
