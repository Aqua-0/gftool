...
namespace TrinityModelViewer
{
    public partial class ModelViewerForm
    {
        ...
        private Button? loadGfpakAnimationsButton;
        ...
        private ToolStripMenuItem? pokemonLoaderToolStripMenuItem;
        private ToolStripMenuItem? useBackupIkCharacterShaderToolStripMenuItem;
        private ToolStripMenuItem? teraEffectToolStripMenuItem;
        private ToolStripMenuItem? teraTypeMenuToolStripMenuItem;
        private readonly Dictionary<Model, GFTool.Renderer.Scene.GraphicsObjects.Particles.TeraPtclAttachment> teraPtclByModel =
            new Dictionary<Model, GFTool.Renderer.Scene.GraphicsObjects.Particles.TeraPtclAttachment>();
        private int lastTeraPtclTypeIndex = -1;
        private string lastTeraPtclSvRoot = string.Empty;
        private readonly Tera.GemArrayResolver gemArrayResolver = new Tera.GemArrayResolver();
        ...
        private ToolStripMenuItem? exportTrinityReserializeToolStripMenuItem;
        private TabPage? jsonEditorTabPage;
        private DataGridView? jsonFilesGrid;
        private Button? refreshJsonFilesButton;
        private TabPage? morphTargetsTabPage;
        private ListView? morphTargetsListView;
        private TrackBar? morphWeightTrackBar;
        private NumericUpDown? morphWeightNumeric;
        private Button? morphResetButton;
        private Button? morphRefreshButton;
        private Label? morphSelectionLabel;
        private bool isUpdatingMorphUi;
